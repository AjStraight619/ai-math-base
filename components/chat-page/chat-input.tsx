...
const ChatInput = ({
  ...
  return (
    <form
      ...
      className="fixed bottom-0 left-0 right-0 lg:left-0 z-50"
    >
      <motion.div
        variants={sidebarPresenceVariants}
        animate={isSidebarOpen ? "sidebarOpen" : "sidebarClosed"}
        initial="sidebarClosed"
        className="shadow-md mx-auto p-2 mb-2 w-full lg:w-[calc(100% - 12rem)] w-full md:max-w-2xl sm:max-w-xl relative"
      >
        <Textarea
          style={{
            lineHeight: "1",
          ...
          className="w-full resize-none rounded-2xl pt-4 pl-9 pr-10 overflow-y-auto"
        />
